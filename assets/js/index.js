...
(function subMenus() {
  ...
  function pointerEntersMainMenu(e) {
    ...
    if (menuElementtarget.classList.contains("menu__main-item") || menuElementtarget.closest(".menu__main-item")) {
      ...
      subMenu.addEventListener("pointerleave", function pointerLeavesSubMenu(e2) {
        const { relatedTarget } = e2;
        if (relatedTarget === menuElementtarget)
          return;
  ...
  function pointerLeavesMenuItem(e) {
    ...
    if (subMenu)
      return;
    {
      const elementToHide = ((_a = target.nextElementSibling) == null ? void 0 : _a.classList.contains(subMenuClass)) ? target.nextElementSibling : null;
      if (!elementToHide)
        return;
  ...
  function getSubMenu(target) {
    const menuItemWrapper2 = target == null ? void 0 : target.closest(".menu__main-item-wrapper");
    if (!menuItemWrapper2)
      return null;

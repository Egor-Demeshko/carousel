...
<head >
    ...
    <style>
        ...
        <script type="module" src="/assets/js/index-urCCW88a.js"></script>
        <link rel="stylesheet" href="/assets/css/index-Fl-n9Wk0.css">
</head>


<body style="background-image: url(/assets/images/main_bg.svg);">    
    <div class="header__background">
        <div class="header__background_image" style="background-image: url(/assets/images/background.png);">
        </div>
    ...
    <header class="header">
        <span><a class="header__logo" href="/">Логотип</a></span>
